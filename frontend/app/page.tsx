            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {certificates.map((cert, i) => (
                ...
                >
                  ...
                  <h3 className="mb-2 text-xl font-semibold">{cert.title?.[currentLang]}</h3>
        ...
        >
          ...
          >
            <div className="mb-4 flex items-start justify-between">
              <div className="flex-1 pr-12">
                <h2 className="text-3xl font-bold">
                  {certificates[selectedCertificate].title?.[currentLang]}
                </h2>
            ...
            <div className="mb-6 overflow-hidden rounded-xl border border-border/40">
              <img
                src={certificates[selectedCertificate].image_url || "/placeholder.svg"}
                alt={certificates[selectedCertificate].title?.[currentLang] || ""}
            ...
            <div className="space-y-4">
              ...
              <p className="leading-relaxed text-muted-foreground">
                {certificates[selectedCertificate].description?.[currentLang]}
              </p>
            </div>
          </div>
        </div>
